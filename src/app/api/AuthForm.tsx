    ...
    <Card>
     <TextAnimator text="Welcome to AI-NoteTaker"/>
      ...
      <CardContent className="relative gap-2">
        <div className="space-y-6 mb-8"> {/* Adjusted space-y */}
          <div>
      ...
      <CardFooter>
        ...
        >
          {isPending ? <Loader2 className="animate-spin" /> : type === "signup" ? "Sign Up" : "Log In"}
        </Button>
        <p className="text-sm font-thin flex gap-2 items-center">
          {isLoginFrom ? "Don't have an account yet" : "Already have an account"}{" "}
          <Link
